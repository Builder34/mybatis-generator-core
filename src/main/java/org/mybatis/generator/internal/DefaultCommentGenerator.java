...
public class DefaultCommentGenerator implements CommentGenerator {
    ...
    public void addJavaFileComment(CompilationUnit compilationUnit) {
       ...
       // compilationUnit.addFileCommentLine(" * " + compilationUnit.getType().getShortName() + ".java") ;
        //compilationUnit.addFileCommentLine(" * Copyright (C) 2016-2017 吖彪快跑34" ) ;
    ...
    public void addClassComment(InnerClass innerClass,
        ...
        innerClass.addJavaDocLine(" * @author 吖彪快跑34"); //$NON-NLS-1$
        innerClass
	...
	public void addFieldComment(Field field,
        ...
        field
                .addJavaDocLine(" * @author 吖彪快跑34"); //$NON-NLS-1$

        sb.append(" * This field corresponds to the database column "); //$NON-NLS-1$
        sb.append(introspectedTable.getFullyQualifiedTable());
        sb.append('.');
        sb.append(introspectedColumn.getActualColumnName()).append(" ").append(introspectedColumn.getRemarks()) ;
    ...
    public void addFieldComment(Field field, IntrospectedTable introspectedTable) {
        ...
        sb.append(" *  "); //$NON-NLS-1$
        sb.append(introspectedTable.getFullyQualifiedTable()).append(" ").append(introspectedTable.getFullyQualifiedTable().getRemarks()) ;
        field.addJavaDocLine(sb.toString());
